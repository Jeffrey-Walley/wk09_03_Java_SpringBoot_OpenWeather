...
/*
this nearly 100 lines of Constructors, Getters, Setters, and toString()
    // constructor
    public Response(Map<String, String> coord, List<Map<String, String>> weather, String base, Map<String, String> main, Map<String, String> wind, Map<String, String> clouds, String dt, Map<String, String> sys, String id, String name, String cod) {
        this.coord = coord;
